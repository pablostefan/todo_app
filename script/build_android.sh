...
cp android/app/firebase/krykto-$environment-google-services.json android/app/google-services.json && \
flutter clean && flutter build $build_type --obfuscate --split-debug-info=build/app/outputs/symbols --dart-define=ENV=$environment
